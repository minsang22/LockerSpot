...
class ApplyWindow(QMainWindow) :
    def __init__(self) :
        ...
        self.dc = LockerDBController() #CheckPoint 2
        self.dc.settingParkingLotArr() #CheckPoint 3
        self.setlockerlist()()
        
        widget.currentChanged.connect(self.setbtn)
        self.mainmenu.clicked.connect(self.mainmenuBtn)
        self.lockerspace1.clicked.connect(self.changelockerspace1)
        self.lockerspace2.clicked.connect(self.changelockerspace2)
        self.lockerspace3.clicked.connect(self.changelockerspace3)
        self.lockerspace4.clicked.connect(self.changelockerspace4)
        self.lockerspace5.clicked.connect(self.changelockerspace5)
        self.lockerspace6.clicked.connect(self.changelockerspace6)
        self.lockerspace7.clicked.connect(self.changelockerspace7)
        self.lockerspace8.clicked.connect(self.changelockerspace8)
        self.lockerspace9.clicked.connect(self.changelockerspace9)
        self.lockerspace10.clicked.connect(self.changelockerspace10)
    ...
    def setlockerlist(self):
        with open("LockerDB/LockerDB.txt", 'r+') as f: #CheckPoint
            i = 0
            lines = f.readlines()
            for line in lines:
                line = line.rstrip()
                self.dc.LockerDB.parkinglotarr[i] = int(line)
                i += 1

        if self.dc.LockerDB.lockerarr[0] == 0:
            self.loeckerspace1.setText("대여 가능")
        elif self.dc.LockerDB.lockerarr[0] == 1:
            self.lockerspace1.setText("사용 중")
        
        if self.dc.LockerDB.lockerarr[1] == 0:
            self.loeckerspace1.setText("대여 가능")
        elif self.dc.LockerDB.lockerarr[1] == 1:
            self.lockerspace1.setText("사용 중")
            
        if self.dc.LockerDB.lockerarr[2] == 0:
            self.loeckerspace1.setText("대여 가능")
        elif self.dc.LockerDB.lockerarr[2] == 1:
            self.lockerspace1.setText("사용 중")
        
        if self.dc.LockerDB.lockerarr[3] == 0:
            self.loeckerspace1.setText("대여 가능")
        elif self.dc.LockerDB.lockerarr[3] == 1:
            self.lockerspace1.setText("사용 중")
        
        if self.dc.LockerDB.lockerarr[4] == 0:
            self.loeckerspace1.setText("대여 가능")
        elif self.dc.LockerDB.lockerarr[4] == 1:
            self.lockerspace1.setText("사용 중")
        
        if self.dc.LockerDB.lockerarr[5] == 0:
            self.loeckerspace1.setText("대여 가능")
        elif self.dc.LockerDB.lockerarr[5] == 1:
            self.lockerspace1.setText("사용 중")
        
        if self.dc.LockerDB.lockerarr[6] == 0:
            self.loeckerspace1.setText("대여 가능")
        elif self.dc.LockerDB.lockerarr[6] == 1:
            self.lockerspace1.setText("사용 중")
        
        if self.dc.LockerDB.lockerarr[7] == 0:
            self.loeckerspace1.setText("대여 가능")
        elif self.dc.LockerDB.lockerarr[7] == 1:
            self.lockerspace1.setText("사용 중")
        
        if self.dc.LockerDB.lockerarr[8] == 0:
            self.loeckerspace1.setText("대여 가능")
        elif self.dc.LockerDB.lockerarr[8] == 1:
            self.lockerspace1.setText("사용 중")
            
        if self.dc.LockerDB.lockerarr[9] == 0:
            self.loeckerspace1.setText("대여 가능")
        elif self.dc.LockerDB.lockerarr[9] == 1:
            self.lockerspace1.setText("사용 중")
